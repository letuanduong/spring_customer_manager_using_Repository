...
public class CustomerController {
    ...
    public ModelAndView searchCustomerById(@PathVariable Long id, Pageable pageable){
...
//        Iterable<Customer> customers = customerService.findAll(pageable);
    ...
    public ModelAndView searchCustomerByProvince(@RequestParam(defaultValue = "hn") Province province){
